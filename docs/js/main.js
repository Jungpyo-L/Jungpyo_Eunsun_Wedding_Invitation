...
$(document).ready(function () {
    ...
    $(".grm_account_num").text("1234");
    $(".brd_account_num").text("1324");
    $(".GroomAccountName").text("이상하");
    $(".BrideAccountName").text("장문석");
    $(".GroomAccountRelation").text("혼주");
    $(".BrideAccountRelation").text("혼주");

    $(".grm_account_bank2").html("우리은행");
    $(".brd_account_bank2").html("신한은행");
    $(".grm_account_num2").text("1002 943 523660");
    $(".brd_account_num2").text("110 264 079377");
    $(".GroomAccountName2").text("이정표");
    $(".BrideAccountName2").text("장은선");
